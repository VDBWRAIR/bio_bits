# -*- coding: utf-8 -*-
#
# bio_bits documentation build configuration file, created by
...
import bio_bits
projectname = bio_bits.__projectname__
authors = bio_bits.__authors__
version = bio_bits.__version__
release = bio_bits.__release__
